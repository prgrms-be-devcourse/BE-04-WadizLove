...
public class OrderController {
    ...
    @Operation(summary = "주문 생성",
            description = "서포터 정보(supporterId)와 주문 요청 양식(OrderCreateRequestDTO)을 이용하여 주문을 생성합니다.")
    ...
    @Operation(summary = "주문 취소",
            description = "주문 정보(orderId)와 주문한 서포터 정보(supporterId)을 이용하여 주문을 취소합니다.")
    ...
    @Operation(summary = "서포터 주문 기록 조호(단건)",
            description = "주문 정보(orderId)와 주문한 서포터 정보(supporterId)을 이용하여 특정 주문 정보를 조회합니다.")
    ...
    @Operation(summary = "서포터 주문 기록 조회(다건)",
            description = "주문한 서포터 정보(supporterId)을 이용하여 주문 정보 목록을 조회합니다.")
    ...
    @Operation(summary = "메이커 프로젝트 기록 조회(다건)",
            description = "프로젝트 정보(projectId)와 메이커 정보(makerId) 이용하여 메이커 주문 목록을 조회합니다.")
