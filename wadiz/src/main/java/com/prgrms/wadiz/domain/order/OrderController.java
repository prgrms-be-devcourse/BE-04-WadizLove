...
public class OrderController {
     ...
     * Order create
     */
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "주문 생성 성공"),
            @ApiResponse(responseCode = "404", description = "주문 생성 실패")})
    ...
    public ResponseEntity<ResponseTemplate> createOrder(
        ...
        for (OrderRewardCreateRequestDTO orderReward : orderCreateRequestDto.orderRewards()) {
            request.put(orderReward.rewardId(), orderReward.orderQuantity());
        }
